...
*/
require_once("../layout/include/fgcontactform.php");
require_once("../layout/include/simple-captcha.php");
...
$formproc->AddRecipient('ram@xpressionsunlimited.com'); //<<---Put your email address here
...
if(isset($_POST['submitted']))
{
   ...
   {
        $formproc->RedirectToURL("../layout/scripts/thank-you.php");
   }
}
...
<head>
      ...
      <link rel="STYLESHEET" type="text/css" href="../layout/styles/contact.css" />
